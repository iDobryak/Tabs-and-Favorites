...
- Перенос вкладок одного сайта в отдельное окно.
...
| `Разнести сайты по окнам` | Переместить вкладки каждого сайта в отдельное окно |
...
После изменения файлов `popup.html`, `popup.css`, `popup.js` или `manifest.json`:
